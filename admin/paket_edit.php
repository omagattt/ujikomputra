...
<form id="form" method="POST">
    ...
    <input type="hidden" value="<?= $edit['id_paket']; ?>" name="id_paket" class="input"  required>
    <label>Nama Paket</label>
            <div class="content-inputs"> 
                    <input type="text" value="<?= $edit['nama_paket']; ?>" name="nama_paket" class="input"  required>
            </div>
    ...
    <label>Harga</label>
            <div class="content-inputs"> 
                    <input type="text" value="<?= $edit['harga']; ?>" name="harga" class="input"  required>
            </div>
