...
<form id="form" method="POST">
    ...
    <label>Kode Invoice</label>
            <div class="content-inputs"> 
                    <input type="text"  value="<?= $data['kode_invoice'] ?>" name="kode_invoice" class="input" required>
            </div>
    <label>Outlet</label>
            <div class="content-inputs">
            <input type="text"  value="<?= $data['nama_outlet'] ?>" name="nama_outlet" class="input" required>
                  
            </div>
    <label>Pelanggan</label>
            <div class="content-inputs"> 
                    <input type="text" value="<?= $data['nama_member'] ?>" name="nama_member" class="input" required>
            </div>
    ...
    <label>Jumlah</label>
            <div class="content-inputs"> 
                    <input type="text"value="<?= $data['qty'] ?>" name="qty" class="input" required>
            </div>
    <label>Total Harga</label>
            <div class="content-inputs"> 
                    <input type="text" value="<?= $data['total_harga'] ?>" name="biaya_tambahan" class="input" required>
            </div>
            <?php if ($data['total_bayar'] > 0 ): ?>
    <label>Total Bayar</label>
            <div class="content-inputs"> 
                    <input type="text" value="<?= $data['total_bayar'] ?>" name="biaya_tambahan" class="input" required>
            </div>
    <label>Di Bayar Pada Tanggal </label>
            <div class="content-inputs"> 
                    <input type="text" value="<?= $data['tgl_pembayaran'] ?>" name="biaya_tambahan" class="input" required>
            </div>
            <?php else: ?>
    <label>Total Bayar</label>
            <div class="content-inputs"> 
                    <input type="text" placeholder="Belum Melakukan Pembayaran" name="biaya_tambahan" class="input" required>
            </div>
    <label>Batas Waktu Pembayaran</label>
            <div class="content-inputs"> 
                    <input type="text" value="<?= $data['batas_waktu'] ?>" name="biaya_tambahan" class="input" required>
            </div>
            <?php  endif;?>
