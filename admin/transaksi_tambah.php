...
?>
    ...
    <label>Kode Invoice</label>
            <div class="content-inputs"> 
                    <input type="text"  value="<?= $invoice ?>"  name="kode_invoice" readonly="" class="input" required>
            </div>
    <label>Outlet</label>
            <div class="content-inputs">
            <input type="text" name="nama_outlet" value="<?= $outlet['nama_outlet'] ?>"  readonly="" class="input" required>
                  
            </div>
    <label>Pelanggan</label>
            <div class="content-inputs"> 
                    <input type="text"  name="nama_member" value="<?= $member['nama_member'] ?>"  readonly="" class="input" required>
            </div>
    ...
    <label>Jumlah</label>
            <div class="content-inputs"> 
                    <input type="text" placeholder="0" name="qty" class="input" required>
            </div>
            
    <label>Biaya Tambahan</label>
            <div class="content-inputs"> 
                    <input type="text" placeholder="0" name="biaya_tambahan" class="input" required>
            </div>

    <label>Diskon (%)</label>
            <div class="content-inputs"> 
                    <input type="text" placeholder="0" name="diskon" class="input" required>
            </div>
