...
<form id="form" method="POST">
    ...
    <label>No KTP Member</label>
            <div class="content-inputs"> 
                    <input type="text"   name="no_ktp" class="input" required>
            </div>
    <label>Nama Member</label>
            <div class="content-inputs">
            <input type="text"  name="nama_member" class="input" required>
                  
            </div>
    <label>Alamat Member</label>
            <div class="content-inputs"> 
                    <input type="text"  name="alamat_member" class="input" required>
            </div>
    <label>No Telepon</label>
            <div class="content-inputs"> 
                    <input type="text"  name="telp_member" class="input" required>
            </div>
