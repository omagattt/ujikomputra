...
<form id="form" method="POST">
    ...
    <label>Nama Pengguna</label>
            <div class="content-inputs"> 
                    <input type="text"  value="<?= $edit['nama_user']; ?>" name="nama_user" class="input" required>
            </div>
    <label>Username</label>
            <div class="content-inputs"> 
                    <input type="text"  value="<?= $edit['username']; ?>" name="username" class="input" required>
            </div>
    <label>Password</label>
            <div class="content-inputs"> 
                    <input type="text"  placeholder="Kosongkan saja jika tidak akan mengubah password" name="password" class="input" required>
            </div>
                      <label>Role</label>
            <div class="content-inputs"> 
