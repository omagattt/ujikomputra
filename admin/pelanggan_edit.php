...
<form id="form" method="POST">
    ...
    <label>No KTP Member</label>
            <div class="content-inputs"> 
                    <input type="text"  value="<?= $edit['no_ktp']; ?>" name="no_ktp" class="input"  required>
            </div>
    <label>Nama Member</label>
            <div class="content-inputs"> 
                    <input type="text"  value="<?= $edit['nama_member']; ?>" name="nama_member" class="input"  required>

            </div>
    <label>Alamat Member</label>
            <div class="content-inputs"> 
                    <input type="text"  value="<?= $edit['alamat_member']; ?>" name="alamat_member" class="input"  required>
            </div>

    <label>No Telepon</label>
            <div class="content-inputs"> 
                    <input type="text"  value="<?= $edit['telp_member']; ?>" name="telp_member" class="input"  required>
